...
describe('[TextInput]', () => {
    ...
    describe('[Getters and Setters]', () => {
        ...
        it('Should check if input email is not valid', () => {
           ...
           expect(function () {throw new Error("not a valid e-mail address")}).toThrow("not a valid e-mail address");
        });
        ...
        it('Should get input text value is valid', () => {
           ...
           expect(textInput.isTextValid()).toBeTruthy();
        }); 
        ...
        it('Should get input text value is not valid', () => {
           ...
           expect(textInput.isTextValid()).toBeFalsy();
        }); 
        ...
        it('Should get and set input text valid', () => {
            ...
            textInput = new TextInput('.container-text-input-box');
            textInput.setTextValid(false);

           expect(textInput.getTextValid()).toBeFalsy();
        }); 
});